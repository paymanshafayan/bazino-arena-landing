...
> **منبع قالب:** ریپوی `paymanshafayan/bazino-arena-landing`، برنچ **`arena/01a07c28-bazino-arena-landing`** (پوش‌شده) — پوشه‌ی `hub/`
> **تاریخ:** 2026-09-07
...
4) از کد hub/ در ریپوی landing قالب bazino-hub-theme.zip بساز (id: "bazino-hub"، layout: "hub"، نسخه‌ی ۱٫۰٫۰):
   ...
   - رفتارهای تعاملی دمو را حفظ کن: اسلایدر، تب‌ها، انتخاب KIDS/ADULTS/REQUESTS و جریان رزرو داخل Games (انتخاب ایستیشن + ساعت + PayTR — درگاه واقعی پورتال)، پاپ‌آپ ساعات روزبه‌روز با X، مودال ورود (OTP واقعی + تب رمز)، ۹ تب پروفایل با داده‌ی واقعی user، پروفایل/لوگوت فقط از props.
...
5) **تصمیم‌های ۱۶گانه (مستند و لازم‌الاجرا — متن کامل در hub/PORTAL-PDF-DECISIONS.md):**
   ...
   - Games: سه کارت KIDS / ADULTS / GAME REQUESTS + جریان رزرو منتقل‌شده به داخل همین صفحه + پرداخت PayTR
   ...
   - پرداخت: درگاه PayTR پورتال (رزرو/ثبت‌نام/فروشگاه وقتی فعال شد)
...
6. رزرو Games: انتخاب ایستیشن/ساعت → دکمه‌ی PAY & BOOK → درگاه PayTR واقعی باز شود (test mode)
