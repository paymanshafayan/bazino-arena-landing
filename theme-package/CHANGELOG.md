...
- تست‌شده (SSR روی SDK واقعی): با اسلاید ادمینِ دارای تصویر، هیچ `<img>` اسلایدی در خروجی نیست،
  کلاس `has-slide-media` حذف شده، عنصر ویدئو همیشه حاضر است و متن اسلاید به زبان فعال می‌آید.
