...
await p.screenshot({ path: '/home/user/bazino-arena-landing/previews/bracket-page.png' });
await p.screenshot({ path: '/home/user/bazino-arena-landing/previews/bracket-full.png', fullPage: true });
